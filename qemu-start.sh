...
SIM_AHCIDRV="-drive file=${SIM_DATAIMG},if=none,id=${SIM_AHCI_DRVID}"
...
SIM_SASDRV="-drive file=${SIM_SYSIMG},if=none,id=${SIM_SAS_DRVID}"
...
sudo ${SIM} ${SIM_NAME} ${SIM_BOOT} ${SIM_CPU} ${SIM_MEM} ${SIM_PLATFORM} ${SIM_VGA} ${SIM_MISC} ${SIM_PIVNET} ${SIM_SAS_HD}
